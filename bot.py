...
WEBAPP_URL       = os.getenv("WEBAPP_URL", "https://v0-index-oiho1p1op-ivans-projects-657db5c6.vercel.app")
MENU_BTN_TEXT    = "📋 Открыть меню"
ASK_BTN_TEXT     = "💬 Задать вопрос менеджеру"
PRINT_URL        = os.getenv("PRINT_URL", "https://8f0d-171-6-236-147.ngrok-free.app/order")
